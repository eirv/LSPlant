...
export {
    ...
    using ::jmethodID;
    using ::JNIEnv;
    using ::JNIInvokeInterface;
    using ::JNINativeInterface;
...
using lsplant::jpointer;
using lsplant::jpointerArray;

using lsplant::JNIMonitor;
using lsplant::JNIScopeFrame;
using lsplant::JString;
using lsplant::JUTFString;
using lsplant::ScopedLocalRef;

using lsplant::ScopeOrClass;
using lsplant::ScopeOrObject;
...
using lsplant::JNI_GetStaticField;
...
using lsplant::JNI_SetStaticField;
...
using lsplant::JNI_CallStaticMethod;
...
using lsplant::JNI_CallNonvirtualMethod;
...
using lsplant::JNI_GetSuperclass;
using lsplant::JNI_IsAssignableFrom;
using lsplant::JNI_IsInstanceOf;
using lsplant::JNI_IsSameObject;
using lsplant::JNI_NewGlobalRef;
using lsplant::JNI_NewLocalRef;
using lsplant::JNI_NewString;
using lsplant::JNI_NewStringUTF;
using lsplant::JNI_NewWeakGlobalRef;
using lsplant::JNI_RegisterNatives;

using lsplant::JDirectBuffer;

using lsplant::JLocalObjectList;
using lsplant::JLocalObjectMap;
using lsplant::JObjectList;
using lsplant::JObjectMap;

using ::JNI_CreateJavaVM;
using ::JNI_GetCreatedJavaVMs;
using ::JNI_GetDefaultJavaVMInitArgs;
}  // namespace lsplant

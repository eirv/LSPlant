...
template <Arch kArch>
struct is_arch<kArch>
    : std::integral_constant<bool, kArch == Arch::kCurrent || kArch == Arch::kLPCurrent> {};

template <Arch kFirst, Arch... kRest>
struct is_arch<kFirst, kRest...>
    : std::integral_constant<bool, is_arch<kFirst>::value || is_arch<kRest...>::value> {};
